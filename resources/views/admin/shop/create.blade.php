<x-layouts.admin-app>
    ...
    <div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            <x-admin.form.header title="店舗作成" subTitle="店舗を作成しましょう" />
            <form method="POST" action="{{ route('admin.shop.confirm') }}">
                @csrf
                <!-- Grid -->
                <div class="grid grid-cols-12 gap-4 sm:gap-6">
                    ...
                    <x-admin.form.input id="prefectures" type="text" placeholder="都道府県を入力して下さい"
                        value="{{ old('prefectures') }}" name="prefectures" />
                ...
                <!-- End Grid -->
                <x-admin.form.btns leftBtnName="" leftBtnText="戻る" leftBtnType="a" leftBtnRoute="{{ route('admin.shop.index') }}" rightBtnText="確認" rightBtnType="button" rightBtnRoute="" />
            </form>
        </div>
        <!-- End Card -->
    </div>
